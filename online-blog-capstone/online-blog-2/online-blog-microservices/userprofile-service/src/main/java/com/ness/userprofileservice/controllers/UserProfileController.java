...
public class UserProfileController {
    ...
    public UserProfileController(UserProfileService service) {
	 ...
	 public Set<UserProfileDto> fetchAllFollowers(@PathVariable @Valid Long Id) throws UserNotFoundException {
	 ...
	 public Set<UserProfileDto> fetchAllFollowing(@PathVariable @Valid Long Id) throws UserNotFoundException {
