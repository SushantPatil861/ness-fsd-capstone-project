...
import PostCommentComponent from './PostCommentWindow';
...
export default function PostContentComponent(props) {
    ...
    return(
        <div className="post">
            ...
            { ReactHtmlParser(props.postDetailsObj.content)}
            </div>
            ...
            <PostCommentComponent showComments = {showComments} postObj={props.postObj} refreshPost={props.refreshPost}/>
        </div>
    );
}
